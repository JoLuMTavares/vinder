...
app.get('/nextuser', auth, function(req, res) {
...
app.post('/upload', auth, function(req, res) {
  ...
  uservideo.mv('/home/jan/Desktop/vinder/fileupload/public/files/'+filename+'.mp4' , function(err) {
    if (err)
