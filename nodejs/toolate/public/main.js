                ...
                if (userType === "admin")
                    $('.table tbody').append(`
                        <tr data-id="${data[i]._id}">
                            ...
                            <td><button type="button" class="btn btn-primary btn-delete-laty" onclick="return confirm('This abuser will be removed. Do you confirm?')">Delete</button></td>
                        </tr>
                    `);
                    ...
                    $('.table tbody').append(`
                        <tr data-id="${data[i]._id}">
                            ...
                            <td>${data[i].date}</td>
                            <td>${data[i].time} (${tooLate})</td>
                            <td><button type="button" class="btn btn-primary btn-delete-laty" disabled>Delete</button></td>
                        </tr>
                    `);
            }
        },
        ...
        <div style="margin-top: 100px">
            <h2><b>Laty App</b></h2>
                    <form id="form-login">
                        ...
                        <input type="submit" id="f-login" class="btn btn-primary" value="Login"></input>         
                    </form>
                </div>
            </div>
            </div>            
